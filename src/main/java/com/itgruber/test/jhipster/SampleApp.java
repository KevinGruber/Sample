package com.itgruber.test.jhipster;

import com.itgruber.test.jhipster.config.ApplicationProperties;
import com.itgruber.test.jhipster.config.DefaultProfileUtil;
